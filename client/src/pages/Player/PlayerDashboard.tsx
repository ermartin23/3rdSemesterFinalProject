...
export default function PlayerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#faf6ef]">
          ...
          return (
            <button
              ...
              className={`p-6 border rounded-xl text-lg ${
                isSelected ? "bg-orange-400 text-white" : "bg-[#e8dfcf]"
              }`}
            >
              {num}
            </button>
      ...
      {lastBoard && (
        <div className="mt-10 p-5 bg-white rounded-xl shadow max-w-md mx-auto text-center">
          <h3 className="text-lg font-bold text-red-600 mb-2">
            Last Played Board
          </h3>
          <p>Week: {lastBoard.week} — 2025</p>
          <p>Numbers: {lastBoard.numbers.join(", ")}</p>
          <p>Price Paid: {lastBoard.price} DKK</p>
